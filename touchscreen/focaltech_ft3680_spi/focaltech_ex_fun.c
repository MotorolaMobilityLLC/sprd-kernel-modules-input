...
static DEVICE_ATTR(fts_pen, S_IRUGO | S_IWUSR,
         fts_pen_show, fts_pen_store);
static DEVICE_ATTR(fts_touch_size, S_IRUGO | S_IWUSR,
         fts_touchsize_show, fts_touchsize_store);
static DEVICE_ATTR(fts_ta_mode, S_IRUGO | S_IWUSR,
         fts_tamode_show, fts_tamode_store);
static DEVICE_ATTR(ts_suspend, 0664,
         fts_light_suspend_show, fts_light_suspend_store);
static DEVICE_ATTR(firmware_version, 0664,
         fts_tpfwver_show, fts_tpfwver_store);
static DEVICE_ATTR(input_name, 0664,
         fts_input_name_show, NULL);
static DEVICE_ATTR(dbg_log, 0664,
         fts_dbg_show,	fts_dbg_store);
